...
const Enquiry = () => {
  ...
  function sendEmail(e){
    e.preventDefault();
    emailjs.sendForm('service_dcmcrcr','template_j9c85bq', e.target,'zX9214nB5QDYAk8ci'
    ...
    <div>
      ...
      <Form className='mt-5' onSubmit={sendEmail}>
        <Row>
          ...
          <Form.Control type="text" placeholder="పేరు" name="name" />
        </Form.Group>
          </Col>
          <Col sm={6} md={6}>
          <Form.Group className="mb-3" controlId="formBasicEmail">
          <Form.Label>ఫోన్ నెంబర్ <span>:</span></Form.Label>
          <Form.Control type="tel" placeholder="నెంబర్" name="phone"/>
        </Form.Group>
          </Col>
        </Row>
        <Row>
          ...
          <Form.Control type="email" placeholder="ఇమెయిల్" name="email" />
        </Form.Group>
          </Col>
          <Col sm={6} md={6}>
          <Form.Group className="mb-3" controlId="formBasicEmail">
          <Form.Label>పిన్ నెంబర్ :</Form.Label>
          <Form.Control type="tel" placeholder="పిన్" name="pin" />
        </Form.Group>
          </Col>
        </Row>
        <Row>
          ...
          <Form.Select aria-label="Default select example" name="district">
            <option>జిల్లా/ Select District</option>
            <option value="Visakhapatnam">Visakhapatnam</option>
          ...
          <Form.Select aria-label="Default select example" name='leadership'>
